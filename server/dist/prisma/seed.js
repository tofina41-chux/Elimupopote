...
async function main() {
    ...
    const superadmin = await prisma.user.upsert({
        ...
        update: {},
        create: {
            authUserId: (0, crypto_1.randomUUID)(),
            phone: "+254700000001",
    ...
    const course = existingCourse ??
        (await prisma.course.create({
            data: {
                ...
                description: "A practical course covering the fundamentals of delivering excellent customer service in a logistics business.",
                language: "en",
                status: "PUBLISHED",
                learningObjectives: [
                    ...
                    create: [
                        {
                            ...
                            content: "First impressions matter. This lesson covers professional greetings, tone of voice, and body language when welcoming customers in person, by phone, or by SMS.",
                            quiz: {
                                create: {
                                    tenantId: tenant.id,
                                    questions: {
                        ...
                        },
                        {
                            ...
                            content: "Complaints are opportunities. This lesson teaches the LISTEN-APOLOGIZE-SOLVE framework for de-escalating frustrated customers and resolving issues quickly.",
                            quiz: {
                                create: {
                                    tenantId: tenant.id,
                                    questions: {
